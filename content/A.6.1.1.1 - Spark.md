...
###### A.6.1.1.1.2.6.1.1.3.4 - Avalanche [Core]  <!-- UUID: 00137b5a-f9ef-4539-a986-bd41c540d421 -->
...
###### A.6.1.1.1.2.6.1.4.4 - Avalanche Instances [Core]  <!-- UUID: 03aee0f2-01f5-4a30-bb71-fb5b754b93f4 -->

The documents herein contain all Instances on Avalanche of the Allocation System Primitive with Instance status of `Completed`.
